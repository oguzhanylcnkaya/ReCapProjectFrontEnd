...
export class CarPageComponent implements OnInit {
  ...
  getCarById(){
    ...
    if(this.brandId > 0 && this.colorId > 0){
      this.router.navigate(['car-page/brand/'+ this.brandId +'/color/' + this.colorId])
    }
    else if(this.brandId >= 0){
      if(this.brandId == 0){
        this.router.navigate(['/car-page'])
      }else{
        this.router.navigate(['/car-page/brand/' + this.brandId])
      }
    }
          ...
          if(this.colorId == 0){
            ...
            this.router.navigate(["/car-page/color/" + this.colorId])
          }
        }
